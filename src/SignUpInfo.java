...
public class SignUpInfo {
    ...
    public SignUpInfo() {
        ...
        JLabel names = new JLabel("Enter name:");
        names.setBounds(80, 50, 80, 25);
        signUPFrame.add(names);
        ...
        rollField.setBounds(160, 150, 150, 25);
        ...
        batchField.setBounds(160, 250, 150, 25);
        signUPFrame.add(batchField);

        JButton signUpButton = new JButton("Sign Up");
        signUpButton.setBounds(160, 330, 85, 25);
